...
id             A unique internal name, such as "master-mason-001".
...
correctAnswer  Must exactly match the correct choice above.
  ...
  sourcePrompt   The related wording from the book's discussion questions.
  sourceUrl      A private maintenance link, when one is available.
...
The included 50 questions form Master Mason Degree Set 4:

- 25 easy
- 15 medium
- 10 hard

The source is Oliver Day Street's Symbolism of the Three Degrees, Part Three.
The source page and related discussion prompt are retained as private fields.

This set contains questions 151-200 from unused details on source pages 37-54 and the 1903 New Jersey landmarks appendix. It does not repeat Sets 1, 2, or 3.
The questions should still receive John's final editorial review before publication.
