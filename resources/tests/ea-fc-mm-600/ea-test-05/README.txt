MASONICWORLD ENTERED APPRENTICE TEST - SET 5
============================
...
id             A unique internal name, such as "symbols-001".
...
The included 20 questions form the final Entered Apprentice bank, Set 5:

- 10 easy
- 6 medium
- 4 hard

Source: Oliver Day Street, Symbolism of the Three Degrees, Part One:
The Entered Apprentice Degree (1922), pages 88-93.

The private sourcePage and sourcePrompt fields retain the original page and
discussion-prompt context. The source's discussion prompts are unnumbered.
